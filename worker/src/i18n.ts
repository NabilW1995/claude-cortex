...
const en: Record<string, string> = {
  ...
  // Onboarding
  "onboard.welcome_heading": "\u{1F680} <b>Welcome to Cortex Team Bot!</b>",
  "onboard.welcome_subtitle": "Your team's AI-powered coordination hub \u{2014} right here in Telegram.",
  "onboard.features_heading": "\u{2728} <b>What this bot does:</b>",
  "onboard.feature_claim": "\u{1F4CB} <b>Claim Task</b> \u{2014} Pick a work area, get all issues assigned",
  "onboard.feature_tasks": "\u{2705} <b>My Tasks</b> \u{2014} See your tasks, mark them done, track time",
  "onboard.feature_board": "\u{1F465} <b>Team Board</b> \u{2014} See who's working on what",
  "onboard.feature_idea": "\u{1F4A1} <b>New Idea</b> \u{2014} Create GitHub issues from Telegram",
  "onboard.feature_prompt": "\u{1F916} <b>AI Prompts</b> \u{2014} Get Claude Code prompts for every task",
  "onboard.step1_heading": "<b>Step 1/3: GitHub Account</b>",
  "onboard.step1_prompt": "Please send me your GitHub username:",
  "onboard.github_linked": "\u{2705} <b>GitHub linked!</b>\n\nGitHub: <code>{username}</code>\nTelegram: {firstName}",
  "onboard.step2_heading": "<b>Step 2/3: Notification Settings</b>",
  "onboard.continue_tutorial": "Continue to Tutorial \u{27A1}\u{FE0F}",
  "onboard.tutorial_heading": "\u{1F393} <b>Quick Start Guide</b>",
  "onboard.tutorial_step1": "1. Tap <b>Claim Task</b> \u{2192} Pick a category \u{2192} Issues get assigned to you",
  "onboard.tutorial_step2": "2. Tap <b>My Tasks</b> \u{2192} Start/Done buttons for each task",
  "onboard.tutorial_step3": "3. When all done \u{2192} Category auto-releases \u{2192} Claim a new one",
  "onboard.golden_rule": "\u{1F3C6} <b>Golden Rule:</b> One person per category = no merge conflicts!",
  "onboard.team_status": "\u{1F465} <b>Here's what your team is working on:</b>",
  "onboard.ready": "\u{2705} You're all set! Use the buttons below to get started.",
  "onboard.quick_actions": "\u{2328}\u{FE0F} Quick actions activated!",
...
const de: Record<string, string> = {
  ...
  // Onboarding
  "onboard.welcome_heading": "\u{1F680} <b>Willkommen beim Cortex Team Bot!</b>",
  "onboard.welcome_subtitle": "Das KI-gest\u00fctzte Koordinations-Tool f\u00fcr dein Team \u{2014} direkt in Telegram.",
  "onboard.features_heading": "\u{2728} <b>Was dieser Bot kann:</b>",
  "onboard.feature_claim": "\u{1F4CB} <b>Aufgabe nehmen</b> \u{2014} W\u00e4hle einen Bereich, bekomme alle Issues zugewiesen",
  "onboard.feature_tasks": "\u{2705} <b>Meine Aufgaben</b> \u{2014} Tasks sehen, abhaken, Zeit tracken",
  "onboard.feature_board": "\u{1F465} <b>Team Board</b> \u{2014} Sieh wer an was arbeitet",
  "onboard.feature_idea": "\u{1F4A1} <b>Neue Idee</b> \u{2014} GitHub Issues direkt aus Telegram erstellen",
  "onboard.feature_prompt": "\u{1F916} <b>KI-Prompts</b> \u{2014} Claude Code Prompts f\u00fcr jeden Task",
  "onboard.step1_heading": "<b>Schritt 1/3: GitHub-Account</b>",
  "onboard.step1_prompt": "Bitte sende mir deinen GitHub-Benutzernamen:",
  "onboard.github_linked": "\u{2705} <b>GitHub verkn\u00fcpft!</b>\n\nGitHub: <code>{username}</code>\nTelegram: {firstName}",
  "onboard.step2_heading": "<b>Schritt 2/3: Benachrichtigungen</b>",
  "onboard.continue_tutorial": "Weiter zum Tutorial \u{27A1}\u{FE0F}",
  "onboard.tutorial_heading": "\u{1F393} <b>Schnellstart-Guide</b>",
  "onboard.tutorial_step1": "1. Tippe <b>Aufgabe nehmen</b> \u{2192} Kategorie w\u00e4hlen \u{2192} Issues werden dir zugewiesen",
  "onboard.tutorial_step2": "2. Tippe <b>Meine Aufgaben</b> \u{2192} Start/Done Buttons pro Task",
  "onboard.tutorial_step3": "3. Wenn alles fertig \u{2192} Kategorie wird automatisch freigegeben \u{2192} Nimm eine neue",
  "onboard.golden_rule": "\u{1F3C6} <b>Golden Rule:</b> Eine Kategorie pro Person = keine Merge-Konflikte!",
  "onboard.team_status": "\u{1F465} <b>Dein Team arbeitet gerade an:</b>",
  "onboard.ready": "\u{2705} Alles bereit! Nutze die Buttons unten um loszulegen.",
  "onboard.quick_actions": "\u{2328}\u{FE0F} Quick Actions aktiviert!",
